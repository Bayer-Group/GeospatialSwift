    ...
    public struct MultiLineString: GeoJsonMultiLineString {
        ...
        public func simpleViolations(tolerance: Double) -> [GeoJsonSimpleViolation] {
            ...
            simpleViolationIntersectionIndices.forEach { lineSegmentIndex1 in
                ...
                violations += [GeoJsonSimpleViolation(problems: [point1, point2, line1], reason: .multiLineIntersection)]
                lineSegmentIndex1.value.forEach { lineSegmentIndex2 in
                    ...
                    violations += [GeoJsonSimpleViolation(problems: [point3, point4, line2], reason: .multiLineIntersection)]
                }
            }
