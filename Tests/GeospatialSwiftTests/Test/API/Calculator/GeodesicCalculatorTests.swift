...
class GeodesicCalculatorTests: XCTestCase {
    ...
    func testHasIntersection_SameLine() {
        ...
        let lineSegment = GeodesicLineSegment(point: point, otherPoint: otherPoint)
    ...
    func testHasIntersection_Overlaps_InsideLine_NotEnoughTolerence() {
        ...
        let lineSegment1 = GeodesicLineSegment(point: point, otherPoint: otherPoint)
        
        point = SimplePoint(longitude: 1.2, latitude: 2.2)
        otherPoint = SimplePoint(longitude: 1.7, latitude: 2.7)
        let lineSegment2 = GeodesicLineSegment(point: point, otherPoint: otherPoint)
    ...
    func testHasIntersection_LineIntersectingPolygon_Inside() {
        let lineSegment = GeodesicLineSegment(point: SimplePoint(longitude: 0.2, latitude: 0.5), otherPoint: SimplePoint(longitude: 0.8, latitude: 0.5))
    ...
    func testHasIntersection_LineIntersectingPolygon_OnLine() {
        let lineSegment = GeodesicLineSegment(point: SimplePoint(longitude: 1.5, latitude: 0.5), otherPoint: SimplePoint(longitude: 0.8, latitude: 0.5))
        let polygon = MockData.box
    ...
    func testHasIntersection_LineIntersectingPolygon_CrossesTwice() {
        let lineSegment = GeodesicLineSegment(point: SimplePoint(longitude: 0.9, latitude: 0.5), otherPoint: SimplePoint(longitude: 2.0, latitude: 1.5))
        let polygon = MockData.box
    ...
    func testHasIntersection_LineIntersectingPolygon_LineCrossesThrough() {
        let lineSegment = GeodesicLineSegment(point: SimplePoint(longitude: -1.0, latitude: 0.5), otherPoint: SimplePoint(longitude: 2.0, latitude: 0.5))
        let polygon = MockData.box
    ...
    func testHasIntersection_LineIntersectingPolygon_LineOutside() {
        let lineSegment = GeodesicLineSegment(point: SimplePoint(longitude: 1.5, latitude: 0.5), otherPoint: SimplePoint(longitude: 2.0, latitude: 0.5))
        let polygon = MockData.box
